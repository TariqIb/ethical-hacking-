<?php
/**
 * MyEduConnect - Teacher Profile Page
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted"><?php echo htmlspecialchars($teacher['email']); ?></p>
                                <span class="badge bg-primary">Teacher</span>
                                <hr>
                                <div class="text-start">
                                    <p><strong>Teacher ID:</strong> <?php echo htmlspecialchars($teacher['teacher_id_number']); ?></p>
                                    <p><strong>Department:</strong> <?php echo htmlspecialchars($teacher['department'] ?? 'N/A'); ?></p>
                                    <p><strong>Specialization:</strong> <?php echo htmlspecialchars($teacher['specialization'] ?? 'N/A'); ?></p>
                                    <p><strong>Qualification:</strong> <?php echo htmlspecialchars($teacher['qualification'] ?? 'N/A'); ?></p>
                                    <p><strong>Hire Date:</strong> <?php echo formatDate($teacher['hire_date']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" value="<?php echo htmlspecialchars($teacher['email']); ?>" disabled>
