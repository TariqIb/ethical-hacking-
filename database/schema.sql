...
CREATE TABLE security_settings (
    ...
    sqli_protection TINYINT(1) DEFAULT 1,
    xss_protection TINYINT(1) DEFAULT 1,
    idor_protection TINYINT(1) DEFAULT 1,
    auth_protection TINYINT(1) DEFAULT 1,
    password_protection TINYINT(1) DEFAULT 1,
    file_protection TINYINT(1) DEFAULT 1,
    session_protection TINYINT(1) DEFAULT 1
);
